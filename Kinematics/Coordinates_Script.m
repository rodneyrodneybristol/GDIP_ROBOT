...
T5 = [ref+[0,-itw-c], ref+[itl,-itw-c]; ref+[0,-itw-c-itw] , ref+[itl,-itw-c-itw]]
T6 = [ref+[itl+c,-itw-c], ref+[itl+itl+c,-itw-c] ; ref+[itl+c,-itw-c-itw], ref+[itl+itl+c,-itw-c-itw]]
T7 = [ref+[itl+itl+c+c,-itw-c],ref+[itl+itl+itl+c+c,-itw-c] ; ref+[itl+itl+c+c,-itw-c-itw] , ref+[itl+itl+itl+c+c,-itw-c-itw]]
...
T9 = [ref+[0,-itw-c-itw-c],ref+[itl,-itw-c-itw-c]; ref+[0,-itw-c-itw-c-itw], ref+[itl,-itw-c-itw-c-itw]]
T10 = [ref+[itl+c,-itw-c-itw-c], ref+[itl+itl+c,-itw-c-itw-c]; ref+[itl+c,-itw-c-itw-c-itw], ref+[itl+itl+c,-itw-c-itw-c-itw]]
T11 = [ref+[itl+itl+c+c,-itw-c-itw-c], ref+[itl+itl+itl+c+c,-itw-c-itw-c]; ref+[itl+itl+c+c,-itw-c-itw-c-itw], ref+[itl+itl+itl+c+c,-itw-c-itw-c-itw]]
T12 = [ref+[itl+c+itl+c+itl+c,-itw-c-itw-c], ref+[itl+c+itl+c+itl+c+itl,-itw-c-itw-c]; ref+[itl+c+itl+c+itl+c,-itw-c-itw-c-itw] , ref+[itl+c+itl+c+itl+c+itl,-itw-c-itw-c-itw]]
%one extra tray needed for misc resistors,will be named T_EX
T_EX = [ref+[itl+c+(itl/2),c+itw], ref+[itl+c+(itl/2)+itl,c+itw] ; ref+[itl+c+(itl/2),c] , ref+[itl+c+(itl/2)+itl,c]]
...
M_T_EX = [(T_EX(1)+T_EX(5))/2,(T_EX(3)+T_EX(7))/2]
...
L_EX = sqrt(M_T_EX(1)^2 + M_T_EX(2)^2)
...
theta_1_EX = atand(M_T_EX(2)/M_T_EX(1))
...
% currently L is less than h for tray 9
x_1 = L1-h
x_2 = L2-h
x_3 = L3-h
x_4 = L4-h
...
%theta_2_9 = atand(x_9/d1) will need to calculate theta 3 value 
theta_2_9 = 0
theta_2_10 = atand(x_10/d1)
theta_2_11= atand(x_11/d1)
theta_2_12 = atand(x_12/d1)
theta_2_EX = atand(x_EX/d1)
