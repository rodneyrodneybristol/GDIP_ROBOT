...
T1 = [ref,ref+[itl,0] ; ref + [0,-itw] , ref+[itl,-itw]]
T2 = [ref+[itl+c,0], ref + [itl+itl+c,0] ; ref+[itl+c,-itw] , ref+[itl+itl+c,-itw]]
T3 = [ref+[itl+itl+c+c,0], ref+[itl+itl+itl+c+c,0]; ref+[itl+itl+c+c,-itw], ref+[itl+itl+itl+c+c,-itw]]
% T4 = [ref+[itl+c+itl+c+itl+c,0],ref+[itl+c+itl+c+itl+c+itl,0] ; ref+[itl+c+itl+c+itl+c,-itw], ref+[itl+c+itl+c+itl+c+itl,itw]]
T4 = [ref+[0,-itw-c], ref+[itl,-itw-c]; ref+[0,-itw-c-itw] , ref+[itl,-itw-c-itw]]
T5 = [ref+[itl+c,-itw-c], ref+[itl+itl+c,-itw-c] ; ref+[itl+c,-itw-c-itw], ref+[itl+itl+c,-itw-c-itw]]
T6 = [ref+[itl+itl+c+c,-itw-c],ref+[itl+itl+itl+c+c,-itw-c] ; ref+[itl+itl+c+c,-itw-c-itw] , ref+[itl+itl+itl+c+c,-itw-c-itw]]
...
T7 = [ref+[0,-itw-c-itw-c],ref+[itl,-itw-c-itw-c]; ref+[0,-itw-c-itw-c-itw], ref+[itl,-itw-c-itw-c-itw]]
T8 = [ref+[itl+c,-itw-c-itw-c], ref+[itl+itl+c,-itw-c-itw-c]; ref+[itl+c,-itw-c-itw-c-itw], ref+[itl+itl+c,-itw-c-itw-c-itw]]
T9 = [ref+[itl+itl+c+c,-itw-c-itw-c], ref+[itl+itl+itl+c+c,-itw-c-itw-c]; ref+[itl+itl+c+c,-itw-c-itw-c-itw], ref+[itl+itl+itl+c+c,-itw-c-itw-c-itw]]
T_EX_1 = [ref+[itl+c+itl+c+itl+c,-itw-c-itw-c], ref+[itl+c+itl+c+itl+c+itl,-itw-c-itw-c]; ref+[itl+c+itl+c+itl+c,-itw-c-itw-c-itw] , ref+[itl+c+itl+c+itl+c+itl,-itw-c-itw-c-itw]]
...
T10 = [ref+[0,-itw-c-itw-c-itw-c],ref+[itl,-itw-c-itw-c-itw-c]; ref+ [0,-itw-c-itw-c-itw-c-itw], ref+[itl,-itw-c-itw-c-itw-c-itw]]
T11 = [ref+[itl+c,-itw-c-itw-c-itw-c], ref+[itl+c+itl,-itw-c-itw-c-itw-c]; ref+[itl+c,-itw-c-itw-c-itw-c-itw], ref+[itl+c+itl,-itw-c-itw-c-itw-c-itw]]
T12 = [ref+[itl+itl+c+c,-itw-c-itw-c-itw-c], ref+[itl+itl+itl+c+c,-itw-c-itw-c-itw-c]; ref+[itl+itl+c+c,-itw-c-itw-c-itw-c-itw], ref+[itl+itl+itl+c+c,-itw-c-itw-c-itw-c-itw]]
T_EX_2 = [ref+[itl+c+itl+c+itl+c,-itw-c-itw-c-itw-c], ref+[itl+c+itl+c+itl+c+itl,-itw-c-itw-c-itw-c]; ref+[itl+c+itl+c+itl+c,-itw-c-itw-c-itw-c-itw], ref+[itl+c+itl+c+itl+c+itl,-itw-c-itw-c-itw-c-itw]]
...
% M_T = midpoint of T()
M_T1 = [(T1(1)+T1(5))/2,(T1(3)+T1(7))/2]
M_T2 = [(T2(1)+T2(5))/2,(T2(3)+T2(7))/2]
M_T3 = [(T3(1)+T3(5))/2,(T3(3)+T3(7))/2]
M_T4 = [(T4(1)+T4(5))/2,(T4(3)+T4(7))/2]
M_T5 = [(T5(1)+T5(5))/2,(T5(3)+T5(7))/2]
M_T6 = [(T6(1)+T6(5))/2,(T6(3)+T6(7))/2]
M_T7 = [(T7(1)+T7(5))/2,(T7(3)+T7(7))/2]
M_T8 = [(T8(1)+T8(5))/2,(T8(3)+T8(7))/2]
M_T9 = [(T9(1)+T9(5))/2,(T9(3)+T9(7))/2]
M_T10 = [(T10(1)+T10(5))/2,(T10(3)+T10(7))/2]
M_T11 = [(T11(1)+T11(5))/2,(T11(3)+T11(7))/2]
...
theta_3_5 = theta_3
theta_3_6 = theta_3
theta_3_7 = atand(L9/d1)
theta_3_8 = theta_3
theta_3_9 = theta_3
theta_3_10 = atand(L9/d1)
theta_3_11= theta_3
theta_3_12 = theta_3
